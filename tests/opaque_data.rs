...
use wnf::{AsWnfState, OwnedWnfState, WnfChangeStamp, WnfDataAccessor, WnfOpaqueData};
...
fn subscribe() {
    ...
    let _subscription = state.subscribe(WnfChangeStamp::initial(), move |accessor: WnfDataAccessor<_>| {

...
impl TypeId {
    ...
    ///
    /// It is guaranteed that the returned pointer is either null or points to a valid GUID as long the instance of
    /// [`TypeId`] is live. The returned pointer can be passed to WNF APIs expecting an optional type id.
